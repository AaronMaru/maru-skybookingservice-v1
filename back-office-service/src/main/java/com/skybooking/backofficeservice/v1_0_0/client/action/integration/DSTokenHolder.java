package com.skybooking.backofficeservice.v1_0_0.client.action.integration;
...
import com.skybooking.backofficeservice.v1_0_0.client.model.response.auth.BasicAuthRS;
import com.skybooking.backofficeservice.v1_0_0.io.entity.token.ServiceTokenEntity;
import com.skybooking.backofficeservice.v1_0_0.io.repository.token.ServiceTokenRP;
...
public class DSTokenHolder {
    ...
    final static String HOTEL_SERVICE = "hotel";
