package com.skybooking.backofficeservice.v1_0_0.util;


import com.skybooking.backofficeservice.v1_0_0.util.auth.UserToken;
...
public class JwtUtils {
    ...
    public UserToken userToken() {
        ...
        userToken.setSkyuserId(this.getClaim("stakeholderId", Long.class));
        userToken.setUserRole((this.getClaim("userRole", String.class) != null) ? this.getClaim("userRole", String.class) : "");
        userToken.setUserType((this.getClaim("userType", String.class) != null) ? this.getClaim("userType", String.class) : "");
        return userToken;
    }
