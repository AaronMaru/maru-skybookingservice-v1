package com.skybooking.paymentservice.v1_0_0.util.activitylog;

import com.skybooking.paymentservice.v1_0_0.io.enitity.user.UserEntity;
import com.skybooking.paymentservice.v1_0_0.io.repository.users.StakeHolderUserRP;
import com.skybooking.paymentservice.v1_0_0.io.repository.users.UserRepository;
import com.skybooking.paymentservice.v1_0_0.service.interfaces.activity.ActivitySV;
import com.skybooking.paymentservice.v1_0_0.util.JwtUtils;
...
public class ActivityLoggingBean {
    ...
    public UserEntity getUser(Long stakeholderUserId) {

        var stakeholderUser = stakeHolderUserRP.getOne(stakeholderUserId);
