...
CREATE TABLE `account` (
  ...
  `topup` decimal(8,4) NOT NULL DEFAULT '0.00',
  `withdrawal` decimal(8,4) NOT NULL DEFAULT '0.00',
  `earning` decimal(8,4) NOT NULL DEFAULT '0.00',
  `earning_extra` decimal(8,4) NOT NULL DEFAULT '0.00',
  `refund` decimal(8,4) NOT NULL DEFAULT '0.00',
  `balance` decimal(8,4) NOT NULL DEFAULT '0.00',
  `saved_point` decimal(8,4) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `transaction_values` (
  ...
  `extra_rate` decimal(8,4) NOT NULL,
  `earning_amount` decimal(8,4) NOT NULL,
  `code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `transactions` (
  ...
  `fee` decimal(8,4) NOT NULL DEFAULT '0.00',
  `amount` decimal(8,4) NOT NULL,
  `paid_amount` decimal(8,4) NOT NULL,
