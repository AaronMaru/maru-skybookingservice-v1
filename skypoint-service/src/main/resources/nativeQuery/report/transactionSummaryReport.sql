...
(
	SELECT
        createdAt,
        SUM(topUp) AS topUp,
        SUM(earnedExtra) AS earnedExtra,
        SUM(earnedFlight) AS earnedFlight,
        SUM(earnedHotel) AS earnedHotel,
        SUM(redeemedFlight) AS redeemedFlight,
        SUM(redeemedHotel) AS redeemedHotel,
